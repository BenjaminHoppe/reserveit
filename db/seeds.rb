...
restaurant1 = Restaurant.create!(
  ...
  price_range: 4,
  summary: "Malcolm's restaurant, specializing in Chinese cuisine. Warm atmosphere with excellent food. Try our mapo tofu!",
  user_id: user1.id,
...
restaurant2 = Restaurant.create!(
  ...
  price_range: 1,
  summary: "A bistro with a wide assortment of refreshing drinks and nourishing eats. Friendly staff with fast service.",
  user_id: user2.id,
  address: "20 Elgin St.", 
...
restaurant3 = Restaurant.create!(
  ...
  max_reservation_size: 2,
  price_range: 3,
  summary: "Your spicy food specialists. All-you-can-eat lunch buffet. Be sure to ask our knowledgeable staff about the ingredients we use.",
  user_id: user3.id,
